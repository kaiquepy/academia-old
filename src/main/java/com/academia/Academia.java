...
public class Academia {
    public static void main(String[] args) {
        ...
        Aula YogaAvançado = new AulaSimples("A1", "Pilates", professor1, "08:00", 5);
        Aula Pilates = new AulaSimples("A2", "Spinning", professor1, "10:00", 3);
        PacoteDeAulas pacoteFitness = new PacoteDeAulas("P1", "Pacote Fitness", professor1);
        
        Aula aula1 = new AulaSimples("A001", "Yoga Avançado", professor1, "09:00", 5);
        Aula aula2 = new PacoteDeAulas("P1", "Pacote Fitness", professor1);
